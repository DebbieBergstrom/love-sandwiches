...
def get_sales_data():
    ...
    via the terminal, which must be a stringof 6 numbers, separated by 
...
def update_sales_worksheet(data):
    """ 
    #Update sales worksheet, add ner row with the list of data provided.
    """
...
def update_surplus_worksheet(data):
    """ 
    #Update surplus worksheet, add ner row with the list of data provided.
    """
...
def calculate_surplus_data(sales_row):
    ...
    The surplus is defined as the sales figure subtracted with the stock
